package org.javadsalgo.userbook.userbooks;
 ...
 *
 * Combination of userId and book_id is unique primary key for this table.
 * There is only 1 Partition key and 3 Clustering Key, no Composite key here..
 * We can query using 1 partition key here and get multiple results ...
 *
 * Same fields are being added in this table as well in addition to book_by_userId_and_bookid table
 * so as to make search faster
 */
...
public class BooksByUser {
    ...
    /* This column define ordering within partition , sort by book_Id */
    ...
    /*Special field just to use in model during home display, not saved in DB*/
    @Transient
