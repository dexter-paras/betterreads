...
public class Book {
    ...
    /**
     * A book can have multiple coverIds
     * Based on coverId, we can show coverId full url to download and show image on Book page
     */
    @Column("cover_ids")
    ...
    /**
     * A book can have multiple authorIds
     * authorIds help to navigate to Author in case user click author on the page
     */
    @Column("author_ids")
    @CassandraType(type = CassandraType.Name.LIST,typeArguments = CassandraType.Name.TEXT)
